...
static const ParamConfig_t g_param_config[PARAM_MAX_COUNT] = {
    ...
    [PARAM_MQTT_HOST] = {.name = "mqtt_host",   .type = PARAM_TYPE_STRING, .persist = TRUE,  .default_value.str = ""},
    [PARAM_DEVICE_ID] = {.name = "device_id",   .type = PARAM_TYPE_STRING, .persist = TRUE,  .default_value.str = ""},
    [PARAM_MQTT_PORT] = {.name = "mqtt_port",   .type = PARAM_TYPE_INT16,  .persist = TRUE,  .default_value.i16 = 0},
    [PARAM_IO_STATE]  = {.name = "io_state",    .type = PARAM_TYPE_INT8,   .persist = FALSE, .default_value.i8  = 0},
    [PARAM_NET_RSSI]  = {.name = "net_rssi",    .type = PARAM_TYPE_INT8,   .persist = FALSE, .default_value.i8  = 0},
    [PARAM_BATTERY_ACTIVATION] = {.name = "battery_activation", .type = PARAM_TYPE_INT8, .persist = FALSE, .default_value.i8 = 0},
    [PARAM_IO_EXP_OUT0] = {.name = "io_exp_out0", .type = PARAM_TYPE_INT8, .persist = FALSE, .default_value.i8 = 1},
    [PARAM_IO_EXP_OUT1] = {.name = "io_exp_out1", .type = PARAM_TYPE_INT8, .persist = FALSE, .default_value.i8 = 1},
    [PARAM_IO_EXP_OUT2] = {.name = "io_exp_out2", .type = PARAM_TYPE_INT8, .persist = FALSE, .default_value.i8 = 1},
    [PARAM_IO_EXP_OUT3] = {.name = "io_exp_out3", .type = PARAM_TYPE_INT8, .persist = FALSE, .default_value.i8 = 1},
    [PARAM_IO_EXP_IN0] = {.name = "io_exp_in0", .type = PARAM_TYPE_INT8, .persist = FALSE, .default_value.i8 = 0},
    [PARAM_IO_EXP_IN1] = {.name = "io_exp_in1", .type = PARAM_TYPE_INT8, .persist = FALSE, .default_value.i8 = 0},
    [PARAM_IO_EXP_IN2] = {.name = "io_exp_in2", .type = PARAM_TYPE_INT8, .persist = FALSE, .default_value.i8 = 0},
    [PARAM_IO_EXP_IN3] = {.name = "io_exp_in3", .type = PARAM_TYPE_INT8, .persist = FALSE, .default_value.i8 = 0},
};
