...
static const ParamConfig_t g_param_config[PARAM_MAX_COUNT] = {
    ...
    [PARAM_BATTERY_ACTIVATION] = {.name = "battery activation", .type = PARAM_TYPE_INT8, .persist = FALSE, .default_value.i8 = 0},
    [PARAM_IO_EXP_OUT0] = {.name = "io exp out0", .type = PARAM_TYPE_INT8, .persist = FALSE, .default_value.i8 = 1},
    [PARAM_IO_EXP_OUT2] = {.name = "io exp out1", .type = PARAM_TYPE_INT8, .persist = FALSE, .default_value.i8 = 1},
    [PARAM_IO_EXP_OUT3] = {.name = "io exp out2", .type = PARAM_TYPE_INT8, .persist = FALSE, .default_value.i8 = 1},
    [PARAM_IO_EXP_OUT1] = {.name = "io exp out3", .type = PARAM_TYPE_INT8, .persist = FALSE, .default_value.i8 = 1},
    ...
    [PARAM_ALERT_PHONE_1] = {.name = "alert phone 1", .type = PARAM_TYPE_STRING, .persist = TRUE, .default_value.str = "+989129459183"},
    [PARAM_ALERT_PHONE_2] = {.name = "alert phone 2", .type = PARAM_TYPE_STRING, .persist = TRUE, .default_value.str = "+989129459183"},
    [PARAM_ALERT_PHONE_3] = {.name ="alert phone 3", .type = PARAM_TYPE_STRING, .persist = TRUE, .default_value.str = "+989129459183"},
};
